<template>
    ...
    <el-dialog draggable v-model="dialogVisible7" title="1号U型辊架状态" width="50%">
        ...
        <div class="bottombox">
            <div v-if="istatus == 3" class="btfont">请确保C06 C07工位存在空辊框 可以通过AGV半自动任务 搬运空辊框到C06 或者C07工位</div>
            <div v-if="istatus == 1" class="my-2 flex items-center text-sm">
                <el-radio-group v-model="radio" class="ml-4">
                    <el-radio style="color: black" label="15">下发至15号磨床</el-radio>
                    <el-radio style="color: black" label="16">下发至16号磨床</el-radio><br /><br />
                </el-radio-group>
                <br /><br />
...
import { updateFrame, getFrameChild, insertProduce, selectProduceAll, selectFrameByType, getGrindAllAndData, getFrame, selectGrindParameterTry, updateFrameChild, updateElectronic, remFrame, addFrame, getDcad, updateDcad, getFrameInfo, insertGrind_Carry, selectFrameRegionAndType } from '@/apis'
